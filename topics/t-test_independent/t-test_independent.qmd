...
Where $k$ is the level of the categorical predictor variable and $d$ is the value of the outcome/dependent variable.
...
DT::datatable(data[,c('classPosition', 'IQ.you')], options = list(searching = FALSE, scrollY = 415, paging = F, info = F))
```
...
IQ.you.front.mean <- mean(IQ.you.front,   na.rm = TRUE)
IQ.you.back.mean <- mean(IQ.you.back, na.rm = TRUE)
...
```{r, echo=TRUE}
IQ.you.front.var   <- var(IQ.you.front,   na.rm = TRUE)
IQ.you.back.var <- var(IQ.you.back, na.rm = TRUE)
print(rbind(IQ.you.front.var, IQ.you.back.var))

IQ.you.front.n   <- length(IQ.you.front)   - 1
IQ.you.back.n <- length(IQ.you.back) - 1
print(rbind(IQ.you.front.n, IQ.you.back.n))
```
