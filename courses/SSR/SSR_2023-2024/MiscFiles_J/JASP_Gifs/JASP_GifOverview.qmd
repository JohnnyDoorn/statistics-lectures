...
To accomodate the use of JASP in SSR, below are various instructional `.gifs`.
...
sorted_indices <- order(match(lectures$analysis, c("Getting-Started", "ANOVA", "ANCOVA", "ANOVA-Factorial")))
...
baseURL <-  
  data.frame(Analysis = lectures$analysis,
             ...
             Link  = sprintf('<a href="https://johnnydoorn.github.io/statistics-lectures/courses/SSR/SSR_2023-2024/MiscFiles_J/Gifs_JASP/%s" target="_blank" class="external">link</a>', 
