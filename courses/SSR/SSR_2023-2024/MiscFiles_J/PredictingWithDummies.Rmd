...
To get the error mean square, we take the error sum of squares of the full model, divided by the error df ($N - k -1 = 26$):`r ssFullModelError` / 26 = `r  ssFullModelError / 26`.
